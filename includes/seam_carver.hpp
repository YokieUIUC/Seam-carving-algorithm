...
public:
  ...
  int** SetVerticalSumEnergyMap() const;

  int** SetHorizontalSumEnergyMap() const;

  void SetVerticalSingleEnergyMap(int row, int col, int** map) const;

  // int** SetEmptyMap() const;

  int** SetEnergyMap() const;

  void ClearMap(int** map) const;

  void ClearMap(int** map1, int** map2) const;

  void SetHorizontalSingleEnergyMap(int row, int col, int** map) const;
